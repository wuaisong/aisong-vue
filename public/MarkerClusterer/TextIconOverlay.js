...
(function () {
    ...
    (function () {
        ...
        baidu.dom.getPosition = function (element) {
            element = baidu.dom.g(element);
            var doc = baidu.dom.getDocument(element), browser = baidu.browser, getStyle = baidu.dom.getStyle, // Gecko 1.9版本以下用getBoxObjectFor计算位置
                // 但是某些情况下是有bug的
                // 对于这些有bug的情况
                // 使用递归查找的方式
            ...
            if (element.getBoundingClientRect) { // IE and Gecko 1.9+
                ...
                var htmlDom = doc.body, // 在这里，不使用element.style.borderLeftWidth，只有computedStyle是可信的
     ...
     *@return 无返回值。
     */
    TextIconOverlay.prototype.setText = function (nodeList) {
        if (nodeList) {
            this._text = nodeList.length;
